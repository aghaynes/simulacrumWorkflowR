...
The latest Simulacrum data is formatted identically to the real CAS data. Once downloaded, the read_csv() function can automatically load the CSV files as data frames in R:
