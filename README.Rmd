...
In the event of an error on NHS servers while executing the analysis pipeline, the `log_func` function and the base R `sink` will generate a comprehensive log to facilitate seamless debugging.
