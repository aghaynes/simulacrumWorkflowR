...
2) Copy the direction to the location of Simulacrum at your locale machine
...
When the data is downloaded and saved, the 'read_csv()' function can automatically setup the csv files as dataframes in R:
...
When the data management, analysis and the table is ready for a full workflow which can be send to NHS, the workflow generator function can be used to make the complete workflow and output it as a R function, which is ready to be send to the NHS: 
